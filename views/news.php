      ...
      <div class="section">
        <div class="products">
          ...
          <div class="productscom newsnvents">
            ...
            <div class="productscom-desc intoview-effect" data-effect="fadeup"><?php echo substr(strip_tags($event->body),0,400)?><br/> <a class="more" href="<?php echo url("news-events")?>"><?php echo Yii::t("strings", "Read more")?> &gt;</a> </div>
