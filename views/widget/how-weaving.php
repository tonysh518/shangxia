		...
		<div class="knowhowcom ">
			...
			<div class="knowhowitem cs-clear intoview-effect" data-effect="fadeup">
				<div class="knowhowintro  knowhowL inout-effect">
					...
					<a href="#" class="btn transition-wrap" data-a="show-pop"><span class="transition">read<br/><br/>read</span></a>
					<textarea style="display:none;">
						<h2>Scraping the Cyan (Bamboo Skin)  </h2>
						<div class="popcontxt">
              <p>The women had to sharpen their knives and be well prepared to scrape the cyan, they had to be quick. The colloid layer has to be scraped from the stalk before the moisture has left the bamboo. A second later, cyan colored fine hair floated from the bamboo, leaving a faint trace of sweet fragrance. </p>
						</div>
					</textarea>
				</div>
			...
			<div class="knowhowitem cs-clear intoview-effect" data-effect="fadeup">
				<div class="knowhowintro  knowhowL inout-effect">
					...
					<a href="#" class="btn transition-wrap" data-a="show-pop"><span class="transition">read<br/><br/>read</span></a>
					<textarea style="display:none;">
						<h2>Drying the Slice</h2>
						<div class="popcontxt">
              <p>The delicately thin slices were hung and dried in a ventilated place. When a breeze drifted through, all of the bluish green pieces floated up and down in the wind, like waves rolling on the water. Looking at the fluttering green, the women can breath a relaxed breathe., </p>
						</div>
					</textarea>
				</div>
			...
			<div class="knowhowitem cs-clear intoview-effect" data-effect="fadeup">
				<div class="knowhowintro  knowhowR inout-effect">
					...
					<a href="#" class="btn transition-wrap" data-a="show-pop"><span class="transition">read<br/><br/>read</span></a>
					<textarea style="display:none;">
						<h2>Separating Strands</h2>
						<div class="popcontxt">
              <p>The dried slices were ready for their last step. In general, a 1 cm wide bamboo slice can be separated into 2 to 48 strands (width ranging from 0.15 mm to 0.5 mm). With the strands separated, we could proceed to weaving.</p>
