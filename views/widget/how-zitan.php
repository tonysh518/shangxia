	...
	<div class="knowhow">
		...
		<div class="knowhowcom ">
			...
			<div class="knowhowitem cs-clear intoview-effect" data-effect="fadeup">
				<div class="knowhowintro  knowhowL inout-effect">
					<span class="inout-bg"></span>
					<p class="eff cwrap">Construction </p>
					<a href="#" class="btn transition-wrap" data-a="show-pop"><span class="transition">read<br/><br/>read</span></a>
					<textarea style="display:none;">
						<h2>Construction</h2>
						<div class="popcontxt">
			...
			<div class="knowhowitem cs-clear intoview-effect" data-effect="fadeup">
				<div class="knowhowintro  knowhowR inout-effect">
					<span class="inout-bg"></span>
					<p class="eff cwrap">Carving</p>
					<a href="#" class="btn transition-wrap" data-a="show-pop"><span class="transition">read<br/><br/>read</span></a>
					<textarea style="display:none;">
						<h2>Carving</h2>
						<div class="popcontxt">
              <p>The carver placed various tools on the table. Zitan is famous for its hardness. If you hammer a nail into the timber, it will leave a mark and bend.</p>
